...
Evaluates fine-tuned literary translation models and baseline models
on the held-out 5 % test split used during training.

Pass --test-file to load a pre-saved JSON test set.

Usage:
    python evaluate-literary.py --models HiTZ/Latxa-Qwen3-VL-8B-Instruct outputs/literaryv1 --test-file outputs/test_set_literary.json
"""
...
def main() -> None:
    ...
    parser.add_argument("--models",          nargs="+", required=True,
                        help="List of model paths or HF base models (e.g., HiTZ/Latxa-Qwen3-VL-8B-Instruct outputs/literaryv1)")
