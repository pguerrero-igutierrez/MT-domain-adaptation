...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/pguerrero005/MT/MT-domain-adaptation/.slurm-finetune/finetune_general_%j.log
#SBATCH --error=/home/pguerrero005/MT/MT-domain-adaptation/.slurm-finetune/finetune_general_%j.err
