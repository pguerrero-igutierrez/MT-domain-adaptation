...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/pguerrero005/MT/MT-domain-adaptation/.slurm-finetune/finetune_cav2_%j.log
#SBATCH --error=/home/pguerrero005/MT/MT-domain-adaptation/.slurm-finetune/finetune_cav2_%j.err
...
python scripts/11_finetuning_literaryv2.py
